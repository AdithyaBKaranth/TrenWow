...
class CompanyForumHolder extends StatefulWidget {
  @override
  State<CompanyForumHolder> createState() => CompanyForumHolderState();
}

class CompanyForumHolderState extends State<CompanyForumHolder> {
  bool _liked = false;
              ...
              IconButton(
                onPressed: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => CompanyInsider('contact 1')));
                },
